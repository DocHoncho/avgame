...
import { createEntity, getWorld } from './world';
import {
  addTransform,
  addVelocity,
  addCollider,
...
export function createBasicEntity(
  ...
  try {
    ...
    console.log(`Created basic entity with ID: ${entity}`);

    // Add transform component
    addTransform(world, entity, x, y, z, options.rotY || 0);
    ...
    console.error('Error creating basic entity:', error);
    throw error;
  }
}
